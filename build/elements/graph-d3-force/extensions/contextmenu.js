...
const style_html = `<style>:host .menu[simulation=running] ::slotted(#start-force),:host .menu[simulation]:not([simulation=running]) ::slotted(#stop-force){color:rgba(51,51,51,.5)}</style>`;
