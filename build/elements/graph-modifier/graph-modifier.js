...
style.textContent = `:host>svg>#node-group>circle.node{transition:opacity .5s,fill .5s,stroke-dasharray .5s}:host>svg>#node-group>circle.node.modifying{fill:#8bc34a;stroke:#33691e;stroke-dasharray:8,2}`;
