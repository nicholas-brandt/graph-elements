...
var d3 = _interopRequire(require("../../node_modules/d3/d3"));

var requestAnimationFunction = require("../external/requestAnimationFunction.amd").requestAnimationFunction;

var mixin = require("../external/mixin.amd").mixin;
